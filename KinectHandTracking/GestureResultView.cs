namespace KinectHandTracking
{
    ...
    public sealed class GestureResultView 
    {
        ...
        {
            //Console.WriteLine("gesture result view");
            /*if (space == null)
            {
        ...
        public float ChompProgress
        {
            ...
            private set
            {
                //Console.WriteLine("set chompprogress " + value);
                //cConsole.WriteLine("set chompprogress " + value);
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool left, bool right, bool straight, float progress, bool chomp, float chompProgress)
        {
           ...
           // Console.WriteLine("UPDATEGESTURE result, chomp: " + this.Chomp);
            //Console.WriteLine("UPDATEGESTURE result, chompProgress: " + this.ChompProgress);
